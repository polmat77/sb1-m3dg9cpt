...
export const Register: React.FC = () => {
  ...
  const [accent, setAccent] = useState<AccentType>('british');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await signUp(email, password, accent);
      navigate('/lessons');
    } catch (error: any) {
        ...
        <Card>
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center">
              Sign up for SayItRight to start improving your English pronunciation
            </CardDescription>
          </CardHeader>
